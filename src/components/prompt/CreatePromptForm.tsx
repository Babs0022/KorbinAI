  ...
  return (
    <div className="space-y-6">
          ...
          <GlassCard>
            ...
            <GlassCardContent>
              ...
              <div className="mt-6 space-y-2">
                <Label>Provide Context (Optional)</Label>
                {imagePreview ? (
                 ...
                 <p className="text-xs text-muted-foreground">Add an image to give the AI more context.</p>
              </div>
            </GlassCardContent>
          </GlassCard>
      ...
      {currentStep === 2 && (
        <GlassCard>
          <GlassCardHeader>
            <GlassCardTitle>2. Refine the Details</GlassCardTitle>
          </GlassCardHeader>
          <GlassCardContent>
