        ...
        <main className="flex-1 py-12 md:py-16">
          <div className="container mx-auto max-w-4xl">
            ...
            <div className="prose dark:prose-invert max-w-none">
              ...
              <p>We may revise these Terms from time to time. We will a_i_notify you of any material changes by posting the new Terms on the Service. Your continued use of the Service after the changes have been posted will constitute your acceptance of the changes.</p>
