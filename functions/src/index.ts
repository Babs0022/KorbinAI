...
// NOTE: These plan codes are examples. You must create plans in your Paystack dashboard
// and replace these with your actual codes.
...
async function processChargeSuccessEvent(eventData: PaystackChargeSuccessData): Promise<void> {
  ...
  // Check both `plan_object` (from subscriptions) and `plan` (from payment pages) for the plan code.
